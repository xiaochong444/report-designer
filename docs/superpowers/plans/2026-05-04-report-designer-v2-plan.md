# 报表设计器 v2 实现计划（对标 Stimulsoft Reports）

> 基于 Stimulsoft Reports Web Designer 功能对比，补充和完善现有计划。

**当前状态：** 基础框架已搭建，核心模型/表达式/命令/渲染引擎基本完成，设计器有基本画布交互，但距离 Stimulsoft 级别还缺少大量功能细节。

---

## 一、现状 vs Stimulsoft 对比

### 1. 画布交互

| 功能 | Stimulsoft | 当前状态 | 差距 |
|------|-----------|---------|------|
| 拖拽移动组件 | ✅ | ✅ | 无 |
| 8方向缩放 | ✅ | ✅ | 无 |
| 框选/多选 | ✅ | ✅ | 无 |
