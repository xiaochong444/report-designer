...
export const designerMessages: Record<DesignerLocale, DesignerMessages> = {
  'zh-CN': {
    ...
    'jsonDataSource.addDataSources': '推断字段',
    ...
    'band.description.hierarchicalData': '该带区用于从自动推断的数组路径输出树形行，并按子字段展开明细。',
  ...
  'en-US': {
    ...
    'jsonDataSource.addDataSources': 'Infer fields',
    ...
    'band.description.hierarchicalData': 'Outputs tree-like rows from an inferred array path and expands child records by their children field.',
