...
describe('Phase 14 canvas zoom layout', () => {
  it('keeps ruler, paper, printable area, and zoom controls aligned at 200%', () => {
    ...
    expect(contentArea.getAttribute('style')).toContain('left: 38px');
    expect(contentArea.getAttribute('style')).toContain('top: 38px');
    expect(contentArea.getAttribute('style')).toContain('width: 718px');
    expect(contentArea.getAttribute('style')).toContain('height: 1047px');
