...
/** 所有组件类型联合 */
export type ReportComponentUnion = TextComponent | ImageComponent | TableComponent | BarcodeComponent | CheckboxComponent | RichtextComponent | SubreportComponent | PanelComponent;
/** 数据上下文 */
