...
export const longTextPaginationTemplate = template('long-text-pagination', 'Long Text Pagination', [
  band('lt-title', 'reportTitle', 12, [
    text('lt-title-text', 'Long Text Pagination', 0, 1, 190, 8, { style: commonTextStyleIds.title }),
  ]),
  ...
  band('lt-data', 'data', 14, [
    ...
    text('lt-paragraph', paragraph, 40, 1, 136, 8, { style: commonTextStyleIds.dataGrow }),
  ], { dataBand: { dataSourceId: 'employees' } }),
  band('lt-page-footer', 'pageFooter', 8, [
    text('lt-page-number', '{PageNumber}/{TotalPages}', 70, 1, 50, 6, { style: commonTextStyleIds.footerCenter }),
  ]),
]);
