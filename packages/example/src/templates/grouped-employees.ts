...
export const groupedEmployeesTemplate = template('grouped-employees', 'Grouped Employees', [
  band('ge-title', 'reportTitle', 12, [
    text('ge-title-text', 'Grouped Employees', 0, 1, 190, 8, { style: commonTextStyleIds.title }),
  ]),
  ...
  band('ge-header', 'header', 9, [
    ...
    text('ge-h-salary', 'Salary', 130, 1, 40, 6, { style: commonTextStyleIds.headerRight }),
  ]),
  ...
  band('ge-data', 'data', 8, [
    ...
    text('ge-salary', moneyExpression('employees', 'salary'), 130, 1, 40, 5, { style: commonTextStyleIds.dataRight }),
  ...
  band('ge-group-footer', 'groupFooter', 10, [
    ...
    text('ge-group-sum', 'SUM({employees.salary})', 90, 2, 80, 5, { style: commonTextStyleIds.footerRight }),
  ]),
  band('ge-footer', 'footer', 10, [
    text('ge-total-count', 'COUNT({employees.name})', 0, 2, 70, 5, { style: commonTextStyleIds.footer }),
    text('ge-total-salary', 'SUM({employees.salary})', 90, 2, 80, 5, { style: commonTextStyleIds.footerRight }),
  ]),
  band('ge-page-footer', 'pageFooter', 8, [
    text('ge-page-number', '{PageNumber}/{TotalPages}', 70, 1, 50, 6, { style: commonTextStyleIds.footerCenter }),
  ]),
]);
